  ...
  return (
    ...
    >
      <div className="text-left space-y-2 w-full md:w-8/12">
        <h1 className="text-primary text-xl md:text-2xl font-bold whitespace-nowrap overflow-hidden text-ellipsis">
          {title}
        </h1>
        <p className="border-t text-muted-foreground text-sm md:text-base">
          {para}
        </p>
